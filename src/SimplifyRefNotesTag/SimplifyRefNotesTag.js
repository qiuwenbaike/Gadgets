...
window.load_Merge_Simplify = function () {
	if (("" + _typeof(window.mergeRefBracket)).toLowerCase() == "function") window.mergeRefBracket();
	if (("" + _typeof(window.simplifyRefNotesTag)).toLowerCase() == "function") window.simplifyRefNotesTag();
